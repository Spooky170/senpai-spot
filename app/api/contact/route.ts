...
export async function POST(req: NextRequest) {
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'Senpai Spot Contact <onboarding@resend.dev>',
        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#111;color:#f5f5f5;border-radius:12px;overflow:hidden;">
            <div style="background:linear-gradient(135deg,#ff7a00,#e05500);padding:24px 32px;">
              ...
              <p style="margin:4px 0 0;font-size:0.85rem;color:rgba(255,255,255,0.8);">New Contact Form Submission</p>
            </div>
            <div style="padding:32px;">
              <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
                ...
                <tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid rgba(255,255,255,0.07);color:#ff7a00;font-size:0.9rem;"><a href="mailto:${email}" style="color:#ff7a00;">${email}</a></td>
                </tr>
                <tr>
