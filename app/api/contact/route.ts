          ...
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#111;color:#f5f5f5;border-radius:12px;overflow:hidden;">
            ...
            <div style="padding:32px;">
              <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #222;color:rgba(255,255,255,0.4);font-size:0.8rem;width:100px;">Name</td>
                  <td style="padding:10px 0;border-bottom:1px solid #222;color:#f5f5f5;font-size:0.9rem;">${name}</td>
                </tr>
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #222;color:rgba(255,255,255,0.4);font-size:0.8rem;">Email</td>
                  <td style="padding:10px 0;border-bottom:1px solid #222;font-size:0.9rem;"><a href="mailto:${email}" style="color:#ff7a00;">${email}</a></td>
                </tr>
                <tr>
              ...
              <p style="margin:24px 0 0;font-size:0.75rem;color:rgba(255,255,255,0.25);">Reply to this email to respond directly to ${name}.</p>
            </div>
          </div>
        `,
      }),
